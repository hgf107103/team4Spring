...
<div id="menuBarOuter">
	<div id="menuBar">
        ...
        <div id="user">
        	 ...
        	 <input id="chat" type="button" class="inputButtonStyle" value="채팅" onclick="window.open('${pageContext.request.contextPath}/chat', 'popup', 'width = 700, height = 950, top = 100, left = 200, location = no');">
