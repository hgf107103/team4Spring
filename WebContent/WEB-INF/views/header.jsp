...
<div id="menuBarOuter">
	<div id="menuBar">
		<div id="mainIcon">
			<img src="${pageContext.request.contextPath}/resources/background/mainIcon.png" onclick="location.href='${pageContext.request.contextPath}'" alt="">
        ...
        <div id="login">
            ...
            <input type="button" id="loginSubmit" class="inputButtonStyle" value="로그인" onclick="location.href = '${pageContext.request.contextPath}'">
        ...
        <div id="user">
             ...
             <input id="logout" type="button" class="inputButtonStyle" value="로그아웃" onclick="location.href='${pageContext.request.contextPath}'">
        </div>
        <%} %>
    </div>
</div>